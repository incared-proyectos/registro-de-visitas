		    	...
		    	<div class="col-12">
			     	<div class="card">
			     	   <div class="card-header bg bg-info">
			     	   		<b><i class="fas fa-laptop-house"></i> Oficinas </b>
			     	   </div>
		              <div class="card-body">
...
<script>
	...
	import FormModal from '@/components/oficinas/Form.vue';
	...
	export default {
	    ...
	    data: function() {
	    	return {
	    		url_table:route('oficinas.index'),
	    		urlform:null,
	    		tipeform:null,
	    		tipemessage:null,
	    		showModal:false,
	    ...
	    methods:{
		 	createform(){
             	...
             	this.urlform = route('oficinas.save')
             	this.tipeform = 'create'
             	this.tipemessage = `Crear Oficina `
             	this.componentKey += 1
             	this.showModal = true
	       	},
		   	createdCell(cell, cellData, rowData) {
		            ...
		            let instance = new actions({
		                propsData: {
		                	id:rowData.id,
		                	url_delete:route('oficinas.delete'),
		                },
		            });
		            instance.$mount();
		            let me = this;
		        	instance.$on('edit_emit', function(event) {
		        		...
		        		me.form = rowData
		             	me.urlform = route('oficinas.update')
		             	me.tipeform = 'update'
