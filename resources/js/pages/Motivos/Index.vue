		    	...
		    	<div class="col-12">
			     	<div class="card">
			     	   <div class="card-header bg bg-info">
			     	   		<b><i class="fas fa-bookmark"></i> Motivos </b>
			     	   </div>
		              <div class="card-body">
...
<script>
	...
	import FormModal from '@/components/motivos/Form.vue';
	...
	export default {
	    ...
	    methods:{
		 	createform(){
             	...
             	this.urlform = route('motivos.save')
             	this.tipeform = 'create'
             	this.tipemessage = `Crear Motivo `
             	this.componentKey += 1
             	this.showModal = true
	       	},
		   	createdCell(cell, cellData, rowData) {
		            ...
		            let instance = new actions({
		                propsData: {
		                	id:rowData.id,
		                	url_delete:route('motivos.delete'),
		                },
		            });
		            instance.$mount();
		            let me = this;
		        	instance.$on('edit_emit', function(event) {
		        		...
		        		me.form = rowData
		             	me.urlform = route('motivos.update')
		             	me.tipeform = 'update'
		             	me.tipemessage = `Actualizar Motivo ${rowData.id} `
		             	me.componentKey += 1
		             	me.showModal=true
		        	})
