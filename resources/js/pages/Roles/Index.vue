		    	...
		    	<div class="col-12">
			     	<div class="card">
			     	   <div class="card-header bg bg-info">
			     	   		<b><i class="fas fa-bookmark"></i> Roles </b>
			     	   </div>
		              <div class="card-body">
...
<script>
	...
	import FormModal from '@/components/rol/Form.vue';
	...
	export default {
	    ...
	    methods:{
		 	createform(){
             	...
             	this.urlform = route('rol.save')
             	this.tipeform = 'create'
             	this.tipemessage = `Crear Rol`
             	this.componentKey += 1
             	this.showModal = true
	       	},
		   	createdCell(cell, cellData, rowData) {
		          	...
		          	$(cell).empty();
		            let actions = Vue.extend(require('@/components/datatables/actionsRol.vue').default);
		        	...
		        	instance.$on('edit_emit', function(event) {
		        		...
		        		me.form = rowData
		             	me.urlform = route('rol.update')
		             	me.tipeform = 'update'
		             	me.tipemessage = `Actualizar Rol ${rowData.id} `
		             	me.componentKey += 1
		             	me.showModal=true
		        	})
